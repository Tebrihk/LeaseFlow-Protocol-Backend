...
const { LateFeeService, calculateFee } = require('../src/services/lateFeeService');
...
describe('LateFeeService', () => {
  ...
  describe('notifications', () => {
    test('creates notifications for tenant and landlord on late fee', () => {
      ...
      expect(notifications.some(n => n.recipientRole === 'tenant')).toBe(true);
      expect(notifications.some(n => n.recipientRole === 'landlord')).toBe(true);
